...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/creight/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/creight/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/creight/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/creight/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/creight/Projects/foobar/lib/utils")
})
